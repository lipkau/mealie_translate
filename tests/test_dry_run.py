...
class TestDiffFormatter:
    ...
    def test_format_recipe_diff_with_instructions_change(self):
        ...
        original = {
            "name": "Test Recipe",
            "recipeInstructions": [{"text": "Preheat oven to 350°F"}],
        }

        translated = {
            "name": "Test Recipe",
            "recipeInstructions": [{"text": "Preheat oven to 175°C"}],
        }
...
class TestDryRunMode:
    ...
    @patch("mealie_translate.recipe_processor.get_logger")
    def test_dry_run_logs_diffs(self, mock_logger):
        ...
        original_recipe = {
            ...
            "recipeInstructions": [{"text": "Original step"}],
        }

        translated_recipe = {
            "name": "Test Recipe (English)",
            "description": "Translated description",
            "recipeInstructions": [{"text": "Translated step"}],
        }
